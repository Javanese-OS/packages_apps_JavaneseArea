package com.javanese.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String javaneseSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, javaneseSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, javaneseSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(javaneseSETTINGSNS, "interval");
            if(newInterval != null)
